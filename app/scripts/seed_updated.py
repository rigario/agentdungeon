...
NPCS = [
    ...
    # ---- Road ----
    {
        ...
        "notes": "Kira is the passive intel gatherer. She's met the Hollow Eye, the orcs, and has seen Del. She connects the road to the larger narrative.",
                ...
                "movement_rules_json": '{"can_visit": ["crossroads", "south-road", "thornhold"], "schedule": "travel", "triggers": [{"flag": "kira_road_assistance", "target": "thornhold", "description": "Kira travels to Thornhold after receiving assistance with her broken wheel"}], "availability_hours": [7, 19]}',
    },
